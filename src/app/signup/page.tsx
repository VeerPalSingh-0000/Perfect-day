        ...
        <div className="glass-card rounded-xl p-10 flex flex-col items-center shadow-2xl border-white/5 bg-[#0A0A0A]/80">
          ...
          <div className="w-full space-y-4">
            <button
              ...
              className={`w-full flex items-center justify-center gap-3 py-4 px-6 bg-[#E2E2E2] text-black rounded-lg transition-all active:scale-[0.98] font-black text-xs uppercase tracking-widest shadow-lg ${
