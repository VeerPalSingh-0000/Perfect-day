...
export default function AnalyticsPage() {
  ...
  return (
    <div className="min-h-screen bg-black text-[#E2E2E2]">
      ...
      <main className="mx-auto w-full max-w-2xl md:max-w-6xl space-y-6 sm:space-y-8 px-4 sm:px-6 pt-20 sm:pt-24 md:pt-28 pb-4">
        {/* Share Header */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6 lg:gap-8 items-start">
          {/* Left Column: Core Stats, Weekly Chart, Heatmap */}
          ...
          {/* Right Column: Weekly Summary, Category Allocation, Day Ratings */}
