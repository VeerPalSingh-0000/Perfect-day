...
export default function HistoryPage() {
  ...
  return (
    <div className="min-h-screen bg-black text-[#E2E2E2]">
      ...
      <main className="mx-auto w-full max-w-3xl md:max-w-6xl px-4 sm:px-6 pt-20 sm:pt-24 md:pt-28 pb-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6 lg:gap-8 items-start">
          ...
          <div className="md:col-span-4 lg:col-span-3 md:sticky md:top-24">
            ...
            <div className="no-scrollbar flex gap-2 overflow-x-auto pb-2 md:hidden mb-6">
              ...
              {availableMonths.map((m) => {
                ...
                return (
                  <button
                    ...
                    className={`flex items-center justify-between rounded-xl px-4 py-3 text-xs uppercase tracking-widest transition-all text-left ${isActive ? "bg-white font-black text-black shadow-[0_0_15px_rgba(255,255,255,0.1)]" : "border border-[#464555]/15 font-bold text-[#8E8D99] hover:bg-white/5"}`}
                  >
          ...
          {/* Right Column: Daily Performance Logs */}
          <div className="md:col-span-8 lg:col-span-9 flex flex-col gap-4 w-full">
            {filteredRecords.length === 0 && (
              <div className="p-8 text-center text-[#464555] font-medium text-sm border border-[#464555]/15 rounded-xl bg-[#0E0E0E]">
