    ...
    <div className="bg-black text-[#E2E2E2] font-body min-h-screen selection:bg-white/20 overflow-x-hidden overflow-y-auto">
      ...
      <nav className="fixed top-0 w-full z-50 bg-black/80 backdrop-blur-xl border-b border-[#464555]/15 flex items-center px-6 h-16 justify-center">
        <div className="flex items-center">
          <span className="text-[#E2E2E2] font-black tracking-[0.2em] uppercase text-sm font-headline">
            STEALTH
          </span>
        </div>
      </nav>
      {/* Main Content Canvas */}
      <main className="relative z-10 h-[100dvh] w-full flex flex-col items-center justify-center pt-20 pb-8 px-6 bg-black overflow-hidden">
        {/* Login Card */}
        <div className="glass-card w-full max-w-md rounded-xl p-6 sm:p-10 flex flex-col items-center premium-shadow max-h-[90vh] overflow-y-auto">
          ...
          <div className="w-full space-y-3 sm:space-y-4">
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-3 py-3.5 sm:py-4 px-6 bg-[#E2E2E2] text-black rounded-lg hover:bg-white transition-all active:scale-[0.98] font-bold text-xs sm:text-sm uppercase tracking-widest"
            >
            ...
            <div className="relative py-4 sm:py-6 flex items-center">
              <div className="flex-grow vanish-divider h-[1px]" />
              <span className="flex-shrink mx-4 text-[9px] sm:text-[10px] font-bold text-[#464555] uppercase tracking-[0.3em]">
                Identity Hub
              </span>
              <div className="flex-grow vanish-divider h-[1px]" />
            </div>
